...
let attempt = 0;
const audiothree = new Audio("sound/correct.mp3");
const audiofour = new Audio("sound/wrong.mp3");
const audiotwo = new Audio("sound/success.mp3");
...
function animateBox() {
    ...
    qbox.classList.remove("fadeintoright");

    void qbox.offsetWidth;

    qbox.classList.add("fadeintoright");
}
...
function quizResult(){
    ...
    resultBox.querySelector(".total-score").innerHTML =correctAnswers +" out of " + questionLimit;
}
